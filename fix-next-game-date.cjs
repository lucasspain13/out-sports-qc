...
// Supabase configuration - You'll need to add your actual values here
const supabaseUrl = process.env.VITE_SUPABASE_URL;
const supabaseServiceKey = process.env.SUPABASE_SERVICE_ROLE_KEY;
const supabaseAnonKey = process.env.VITE_SUPABASE_ANON_KEY;

if (!supabaseUrl) {
  console.log("ℹ️ No VITE_SUPABASE_URL environment variable found");
  console.log("💡 This script requires Supabase environment variables to run");
  console.log("🔧 Make sure to set up your .env file with:");
