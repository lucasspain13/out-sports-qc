    ...
    <div className="border-t-2 border-green-200 pt-8 mt-8">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <div className="border-t pt-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <label htmlFor="emergencyName" className="block text-sm font-semibold text-gray-900 mb-2">
              ...
              <input
                ...
                className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                  errors.emergencyName ? 'border-red-300 bg-red-50' : 'border-gray-300'
                }`}
            ...
            <div>
              <label htmlFor="emergencyPhone" className="block text-sm font-semibold text-gray-900 mb-2">
          ...
          <div className="mt-4">
            <label htmlFor="emergencyRelation" className="block text-sm font-semibold text-gray-900 mb-2">
            ...
            <select
              ...
              className={`w-full px-4 py-3 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
                errors.emergencyRelation ? 'border-red-300 bg-red-50' : 'border-gray-300'
              }`}
            >
            ...
            {errors.emergencyRelation && (
              <p className="text-red-600 text-sm mt-1">{errors.emergencyRelation}</p>
            )}
          </div>
        </div>
